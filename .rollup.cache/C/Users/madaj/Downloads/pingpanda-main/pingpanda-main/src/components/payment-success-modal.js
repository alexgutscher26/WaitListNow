...
export var PaymentSuccessModal = function () {
  ...
  var _b = useQuery({
      ...
      queryFn: function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, client.payment.getUserPlan.$get({})];
              case 1:
                res = _a.sent();
      ...
      refetchInterval: function (query) {
        var _a;
        return ((_a = query.state.data) === null || _a === void 0 ? void 0 : _a.plan) === 'PRO'
          ? false
          : 1000;
      },
    }),
      ...
      children:
        isPending || !isPaymentSuccessful
          ? _jsxs('div', {
              ...
              children: [
                _jsx(LoadingSpinner, { className: 'mb-4' }),
                _jsx('p', {
                  className: 'text-lg/7 font-medium text-gray-900',
                  children: 'Upgrading your account...',
                }),
                _jsx('p', {
                  className: 'text-gray-600 text-sm/6 mt-2 text-center text-pretty',
                  children: 'Please wait while we process your upgrade. This may take a moment.',
                }),
              ],
            })
          : _jsxs(_Fragment, {
              children: [
                _jsx('div', {
                  className:
                    'relative aspect-video border border-gray-200 w-full overflow-hidden rounded-lg bg-gray-50',
                  children: _jsx(Image, {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsx('p', {
                      className: 'text-lg/7 tracking-tight font-medium text-pretty',
                      children: planConfig.success,
                    }),
                    _jsx('p', {
                      className: 'text-gray-600 text-sm/6 text-pretty',
                      children: planConfig.message,
                    }),
                  ],
                }),
                _jsx('div', {
                  ...
                  children: _jsxs(Button, {
                    ...
                    children: [_jsx(CheckIcon, { className: 'mr-2 size-5' }), 'Go to Dashboard'],
                  }),
                }),
              ],
            }),
