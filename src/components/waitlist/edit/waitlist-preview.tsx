            ...
            <div className={`mb-8 ${formLayoutClass}`}>
                ...
                <div className="relative">
                  <input 
                    ...
                    style={{
                      ...
                      borderWidth: '1px',
                      borderRadius: formData.style?.buttonRounded ? getBorderRadius(formData.style.buttonRounded) : '0.5rem',
              ...
              <div className={formData.style?.formLayout === 'inline' ? 'flex-1 min-w-[200px]' : 'w-full'}>
                <button
                  ...
                  style={{
                    backgroundColor: formData.style?.buttonColor || formData.style?.primaryColor || '#3b82f6',
                    color: formData.style?.buttonTextColor || '#ffffff',
                    borderRadius: formData.style?.buttonRounded ? getBorderRadius(formData.style.buttonRounded) : '0.5rem',
                    '--tw-ring-offset-shadow': 'var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color)',
                    '--tw-ring-shadow': 'var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color)',
                    '--tw-ring-color': formData.style?.primaryColor ? `${formData.style.primaryColor}80` : '#3b82f6',
