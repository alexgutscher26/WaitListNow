...
var log = function () {
  ...
  return (
    isDev && console.log.apply(console, __spreadArray(['[Waitlist Subscribers API]'], args, false))
  );
};
      ...
      switch (_c.label) {
        ...
        case 2:
          ...
          if (!waitlist) {
            return [
              2 /*return*/,
              new NextResponse('Waitlist not found or not active', { status: 404 }),
            ];
          }
        ...
        case 3:
          ...
          if (existingSubscriber) {
            return [
              2 /*return*/,
              new NextResponse('Email already subscribed to this waitlist', { status: 400 }),
            ];
          }
          _c.label = 4;
        case 4:
        ...
        case 7:
          ...
          if (error_1 instanceof z.ZodError) {
            return [
              2 /*return*/,
              new NextResponse(JSON.stringify({ errors: error_1.errors }), {
                status: 422,
