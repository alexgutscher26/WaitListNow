import { z } from 'zod';
export var customFieldSchema = z.object({
...
export var waitlistStyleSchema = z.object({
...
export var waitlistSettingsSchema = z.object({
...
export var waitlistFormSchema = z.object({
...
export var waitlistUpdateSchema = waitlistFormSchema.partial();
