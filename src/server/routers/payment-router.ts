...
export const paymentRouter = router<{
  createCheckoutSession: import('../__internals/types').MutationOperation<Record<string, unknown>, Record<string, unknown>>;
  getUserPlan: import('../__internals/types').QueryOperation<Record<string, unknown>, Record<string, unknown>>;
}>({
