...
var ClientLayout = dynamic(
  function () {
    return import('@/components/client-layout').then(function (mod) {
      return mod.ClientLayout;
    });
  },
  {
    ssr: false,
...
var Providers = dynamic(
  function () {
    return import('../app/providers').then(function (mod) {
      return { default: mod.Providers };
    });
  },
  {
    ssr: true,
