...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        if (this.state.hasError) {
            ...
            return (_jsxs("div", { className: "p-4 text-center", children: [_jsx("h2", { className: "text-lg font-medium text-red-600 mb-2", children: "Something went wrong" }), _jsx("p", { className: "text-sm text-gray-600 mb-4", children: "We've been notified about this issue and are working on a fix." }), _jsx("button", { onClick: function () { return window.location.reload(); }, className: "px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500", children: "Reload Page" })] }));
        }
