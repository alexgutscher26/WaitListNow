...
import { ArrowUpRight, BarChart3, Users, Zap, TrendingUp, TrendingDown, Mail, Activity, DollarSign, Bell, Settings, ChevronRight, MoreHorizontal, CheckCircle2, } from 'lucide-react';
...
var getStats = function () { return __awaiter(void 0, void 0, void 0, function () {
    var stats, recentActivity, approvedSubscribers, averageWaitTime, totalWaitTimeMs, avgWaitTimeMs, avgWaitTimeHours, minutes, hours, days, conversionRate, monthlyGrowth, waitlistsWithGrowth, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                console.log('Recent activities count from API:', ((_a = stats.recentActivities) === null || _a === void 0 ? void 0 : _a.length) || 0);
                ...
                recentActivity = (stats.recentActivities || []).map(function (act, index) {
                    ...
                    switch (act.type) {
                        case 'new_subscriber':
                            return __assign(__assign({}, base), { type: 'new_subscriber', email: act.email || '', waitlist: act.waitlist || '', avatar: act.avatar ||
                                    "https://api.dicebear.com/7.x/initials/svg?seed=".concat(act.email || 'user') });
                        case 'waitlist_created':
                            return __assign(__assign({}, base), { type: 'waitlist_created', subscribers: act.subscribers || 0 });
                        case 'referral':
                            return __assign(__assign({}, base), { type: 'referral', referrer: act.referrer || 'someone', referred: act.referred || '', reward: act.reward || 'Early access' });
                        case 'conversion':
                            return __assign(__assign({}, base), { type: 'conversion', revenue: act.revenue || 0, waitlist: act.waitlist || '' });
                        case 'milestone':
                            return __assign(__assign({}, base), { type: 'milestone', message: act.message || '' });
                        default:
                ...
                return [4 /*yield*/, db.subscriber.findMany({
                        where: {
                            status: 'APPROVED',
                            waitlistId: {
                                in: stats.waitlists.map(function (w) { return w.id; }),
                            },
                        },
                        select: {
                            createdAt: true,
            ...
            case 2:
                ...
                if (approvedSubscribers.length > 0) {
                    ...
                    if (avgWaitTimeHours < 1) {
                        ...
                        averageWaitTime = "".concat(minutes, " ").concat(minutes === 1 ? 'minute' : 'minutes');
                    }
                ...
                conversionRate = stats.totalSubscribers > 0
                    ? Math.min(100, Math.round((stats.newThisWeek / stats.totalSubscribers) * 1000) / 10)
                    : 0;
                monthlyGrowth = stats.growthRate * 4;
                return [4 /*yield*/, Promise.all(stats.waitlists.map(function (wl) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, __assign(__assign({}, wl), { growth: Math.round(growth * 10) / 10 })];
                            }
                        });
                    }); }))];
            case 3:
                ...
                return [2 /*return*/, {
                        ...
                        topWaitlists: waitlistsWithGrowth.map(function (wl) { return ({
                            id: wl.id,
                            name: wl.name,
...
var StatCard = function (_a) {
    var title = _a.title, value = _a.value, Icon = _a.icon, trend = _a.trend, trendValue = _a.trendValue, _b = _a.className, className = _b === void 0 ? '' : _b;
    ...
    <CardContent className="p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          {trend && trendValue && (<div className={cn('mt-2 inline-flex items-center text-sm font-medium', trend === 'up' ? 'text-green-600' : 'text-red-600')}>
...
var ActivityItem = function (_a) {
    ...
    return (<div className="flex items-start gap-3 p-3 hover:bg-gray-50 rounded-lg transition-colors">
...
export default function Page(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var stats, user, userData, isAdmin, hasExportAccess, upgradeParam, dbUser, allWaitlists, waitlists;
        var _c = _b.searchParams, searchParams = _c === void 0 ? {} : _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    hasExportAccess = (userData === null || userData === void 0 ? void 0 : userData.plan) !== 'FREE';
                    upgradeParam = searchParams === null || searchParams === void 0 ? void 0 : searchParams.upgrade;
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard title="Total Subscribers" value={stats.totalSubscribers.toLocaleString()} icon={Users} trend="up" trendValue={"+".concat(stats.newThisWeek, " this week")}/>
        <StatCard title="Active Waitlists" value={stats.activeWaitlists} icon={Activity} trend="up" trendValue={"".concat(stats.completedWaitlists, " completed")}/>
        <StatCard title="Conversion Rate" value={"".concat(stats.conversionRate, "%")} icon={BarChart3} trend="up" trendValue="+12.1% from last month"/>
        <StatCard title="System Status" value="All Systems" icon={Activity} trend="up" trendValue="Operational" className="bg-green-50 text-green-700"/>
      </div>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" className="text-sm text-brand-600 hover:text-brand-700">
                View all
          ...
          <CardContent className="p-0">
            <div className="divide-y divide-gray-100">
              {stats.recentActivity && stats.recentActivity.length > 0 ? (stats.recentActivity.map(function (activity) { return (<ActivityItem key={activity.id} activity={activity}/>); })) : (<div className="p-6 text-center text-sm text-gray-500">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between text-sm mb-1">
                  ...
                  <span className={"font-medium ".concat(stats.growthRate > 0
                                ? 'text-green-600'
                                : stats.growthRate < 0
                                    ? 'text-red-600'
                                    : 'text-gray-600')}>
                ...
                <div className="relative pt-1">
                  ...
                  <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-blue-200">
                    <div style={{
                                width: "".concat(Math.min(100, (stats.newThisWeek / Math.max(1, stats.totalSubscribers - stats.newThisWeek)) * 100), "%"),
              ...
              <div>
                ...
                <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-blue-600 transition-all duration-500" style={{
                                width: "".concat(Math.min(100, (stats.totalSubscribers / 1000) * 100), "%"),
                            }}/>
                </div>
              ...
              <div>
                ...
                <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-green-500 transition-all duration-500" style={{
                                width: "".concat((stats.activeWaitlists / (stats.activeWaitlists + stats.completedWaitlists)) * 100, "%"),
                            }}/>
                </div>
              </div>
            </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                {[
                                ...
                                ].map(function (system) { return (<div key={system.name} className="flex items-center p-3 bg-white border border-gray-100 rounded-lg shadow-sm">
                    <div className="flex-shrink-0">
                      <div className={"h-2.5 w-2.5 rounded-full ".concat(system.status === 'operational' ? 'bg-green-500' : 'bg-red-500')}/>
                    </div>
          ...
          {waitlists.length > 0 ? (<>
              <div className="overflow-hidden rounded-lg border">
                <Table>
                  ...
                  <TableBody>
                    {waitlists.map(function (waitlist) { return (<TableRow key={waitlist.id}>
