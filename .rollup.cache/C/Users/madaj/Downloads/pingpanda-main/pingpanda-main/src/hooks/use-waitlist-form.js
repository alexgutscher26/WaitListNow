...
export function useWaitlistForm(initialValues) {
  ...
  var _a = useState(__assign(__assign({}, defaultValues), initialValues)),
    formData = _a[0],
    setFormData = _a[1];
  ...
  var handleChange = useCallback(
    function (e) {
      ...
      setFormData(function (prev) {
        ...
        return __assign(
          __assign({}, prev),
          ((_a = {}), (_a[name] = type === 'checkbox' ? e.target.checked : value), _a),
        );
      });
      ...
      if (errors[name]) {
        setErrors(function (prev) {
          var _a = prev,
            _b = name,
            _ = _a[_b],
            rest = __rest(_a, [typeof _b === 'symbol' ? _b : String(_b)]);
          return rest;
        });
      }
    },
  ...
  var handleCustomFieldChange = useCallback(function (index, field, value) {
    setFormData(function (prev) {
      ...
      updatedFields[index] = __assign(
        __assign({}, updatedFields[index]),
  ...
  var addCustomField = useCallback(function () {
    setFormData(function (prev) {
      return __assign(__assign({}, prev), {
        customFields: __spreadArray(
          __spreadArray([], prev.customFields, true),
          [
            {
  ...
  var removeCustomField = useCallback(function (index) {
    setFormData(function (prev) {
      return __assign(__assign({}, prev), {
        customFields: prev.customFields.filter(function (_, i) {
          return i !== index;
        }),
      });
    });
  ...
  var handleStyleChange = useCallback(function (field, value) {
    setFormData(function (prev) {
      var _a;
      return __assign(__assign({}, prev), {
        style: __assign(__assign({}, prev.style), ((_a = {}), (_a[field] = value), _a)),
      });
    });
  }, []);
  var handleSettingsChange = useCallback(function (field, value) {
    setFormData(function (prev) {
      var _a;
      return __assign(__assign({}, prev), {
        settings: __assign(__assign({}, prev.settings), ((_a = {}), (_a[field] = value), _a)),
      });
    });
  }, []);
  var validateForm = useCallback(
    function () {
      var newErrors = {};
          ...
          switch (_a.label) {
            ...
            case 3:
              ...
              toast({
                title: 'Error',
                description:
                  error_1 instanceof Error ? error_1.message : 'Failed to create waitlist',
                variant: 'destructive',
              });
