...
if (currentScript) {
    ...
    var style_1 = {
        ...
        buttonTextColor: (_d = getAttr('data-button-text-color')) !== null && _d !== void 0 ? _d : undefined,
        backgroundColor: (_e = getAttr('data-background-color')) !== null && _e !== void 0 ? _e : undefined,
        textColor: (_f = getAttr('data-text-color')) !== null && _f !== void 0 ? _f : undefined,
        borderRadius: getAttr('data-button-rounded') === 'md' ? 8 : getAttr('data-button-rounded') === 'lg' ? 16 : undefined,
