...
export function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, json, data, clerkUser, userEmail, user, createError_1, updateData, updatedUser, waitlistName, slug, waitlist, error_1, prismaError;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    clerkUser = _c.sent();
                    if (!clerkUser) {
                        return [2 /*return*/, new NextResponse(JSON.stringify({ error: 'Unauthorized' }), {
                                status: 401,
                                headers: { 'Content-Type': 'application/json' },
                            })];
                    }
                    userEmail = (_b = (_a = clerkUser.emailAddresses) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.emailAddress;
                    if (!userEmail) {
                        return [2 /*return*/, new NextResponse(JSON.stringify({ error: 'Email address not found' }), {
                                status: 400,
                                headers: { 'Content-Type': 'application/json' },
                            })];
                    }
                ...
                case 6:
                    ...
                    return [2 /*return*/, new NextResponse(JSON.stringify({ error: 'Failed to create user' }), {
                            status: 500,
                            headers: { 'Content-Type': 'application/json' },
                        })];
                ...
                case 10:
                    ...
                    slug = waitlistName
                        ...
                        .replace(/[^a-z0-9]+/g, '-')
                        .replace(/(^-|-$)/g, '');
                    return [4 /*yield*/, db.waitlist.create({
                            data: {
                                name: waitlistName,
