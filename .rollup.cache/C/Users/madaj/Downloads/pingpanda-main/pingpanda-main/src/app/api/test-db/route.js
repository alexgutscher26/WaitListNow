...
export function GET() {
    return __awaiter(this, void 0, void 0, function () {
        var identifier, success, user, dbUser, userByEmail, allUsers, dbError_1, users, queryError_1, responseHeaders, error_1, errorMessage;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (!success) {
                        return [2 /*return*/, NextResponse.json({ success: false, error: 'Too many requests' }, {
                                status: 429,
                                headers: {
                                    'Retry-After': '60',
                ...
                case 3:
                    user = _e.sent();
                    if (!user) {
                        return [2 /*return*/, NextResponse.json({ success: false, error: 'Unauthorized' }, {
                                status: 401,
                ...
                case 5:
                    ...
                    dbUser = _e.sent();
                    if (!(!dbUser && ((_b = (_a = user.emailAddresses) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.emailAddress))) return [3 /*break*/, 7];
                ...
                case 8:
                    ...
                    return [2 /*return*/, NextResponse.json({
                            ...
                            debug: {
                                clerkUserId: user.id,
                                clerkEmail: (_d = (_c = user.emailAddresses) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.emailAddress,
                ...
                case 10:
                    ...
                    return [2 /*return*/, NextResponse.json({ success: false, error: 'Database error' }, {
                            status: 500,
                            headers: { 'Cache-Control': 'no-store, max-age=0' },
                        })];
                case 11:
                ...
                case 14:
                    ...
                    return [2 /*return*/, NextResponse.json({ success: false, error: 'Query error' }, {
                            status: 500,
                            headers: { 'Cache-Control': 'no-store, max-age=0' },
                        })];
                case 15:
