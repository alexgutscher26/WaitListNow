  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      ...
      <p className="mb-6 text-gray-600">
        You can embed your waitlist widget on any website using the iframe code below. Customize the
        options and copy the code to your site.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4 text-gray-700">
        <li>
          Copy and paste the iframe code into your website's HTML where you want the widget to
          appear.
        </li>
      ...
      <ul className="list-disc pl-6 text-gray-700">
        <li>
          <b>waitlistId</b> (required): Your waitlist's unique ID
        </li>
        <li>
          <b>buttonText</b>: Text for the submit button
        </li>
        <li>
          <b>buttonColor</b>: Button background color (hex)
        </li>
        <li>
          <b>buttonTextColor</b>: Button text color (hex)
        </li>
        <li>
          <b>backgroundColor</b>: Widget background color (hex)
        </li>
        <li>
          <b>textColor</b>: Widget text color (hex)
        </li>
        <li>
          <b>borderRadius</b>: Border radius in px
        </li>
        <li>
          <b>fontFamily</b>: Custom font family
        </li>
        <li>
          <b>showLabels</b>: Show field labels (true/false)
        </li>
        <li>
          <b>formLayout</b>: "stacked" or "inline"
        </li>
        <li>
          <b>showBranding</b>: Show "Powered by WaitlistNow" (true/false)
        </li>
      </ul>
    </div>
  );
