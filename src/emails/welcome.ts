...
export function getWelcomeEmail({ name, waitlistName }: WelcomeEmailParams) {
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .header { background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); padding: 32px 24px; text-align: center; color: #fff; }
    ...
    <body>
      <div class="container">
        <div class="email-wrapper">
          <div class="header">
            <h1>Welcome to ${wlName}!</h1>
          </div>
          <div class="content">
            <h2>${displayName}</h2>
            <p>Thank you for joining ${wlName}. We're excited to have you on board! 🎉</p>
...
Thank you for joining ${wlName}. We're excited to have you on board!

We'll keep you updated with the latest news and let you know as soon as we launch.
