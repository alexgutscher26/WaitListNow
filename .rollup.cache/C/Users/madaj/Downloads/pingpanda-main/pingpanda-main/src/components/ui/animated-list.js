...
export var AnimatedList = React.memo(function (_a) {
    ...
    return (_jsx("div", { className: "flex flex-col-reverse items-center gap-4 ".concat(className), children: _jsx(AnimatePresence, { children: messages.map(function (item) { return (_jsx(AnimatedListItem, { children: item }, item.key)); }) }) }));
});
