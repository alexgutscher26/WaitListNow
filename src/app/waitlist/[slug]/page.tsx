...
export default async function WaitlistPage({ params }: WaitlistPageProps) {
  ...
  try {
    ...
    const style: WaitlistStyle = waitlist.style && typeof waitlist.style === 'object' && !Array.isArray(waitlist.style)
      ? waitlist.style as WaitlistStyle 
      : {};

    const settings = waitlist.settings && typeof waitlist.settings === 'object' && !Array.isArray(waitlist.settings)
      ? waitlist.settings 
      : {};
          ...
          <div className="bg-white rounded-b-xl shadow-lg overflow-hidden">
            <div className="px-12 py-16 text-center">
              ...
              <p className="text-gray-500 text-base font-normal mb-6">
                Join {waitlist._count?.subscribers ? waitlist._count.subscribers.toLocaleString() : '1,247'} others on the waitlist
              </p>
