...
export function WaitlistWidget(_a) {
    var _this = this;
    var waitlistId = _a.waitlistId, _b = _a.style, style = _b === void 0 ? {} : _b, apiKey = _a.apiKey, _c = _a.className, className = _c === void 0 ? '' : _c;
