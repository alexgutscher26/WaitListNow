...
export function WaitlistWidget(_a) {
  ...
  var waitlistId = _a.waitlistId,
    ...
    apiKey = _a.apiKey,
    _c = _a.showBranding,
    showBranding = _c === void 0 ? true : _c,
    _d = _a.className,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              fetch('/api/waitlists/'.concat(waitlistId, '/subscribers'), {
                method: 'POST',
                headers: __assign(
                  { 'Content-Type': 'application/json' },
                  apiKey ? { Authorization: 'Bearer '.concat(apiKey) } : {},
                ),
  ...
  var _h = style || {},
    _j = _h.buttonText,
    buttonText = _j === void 0 ? 'Join Waitlist' : _j,
    _k = _h.buttonColor,
    buttonColor = _k === void 0 ? '' : _k,
    _l = _h.buttonTextColor,
    buttonTextColor = _l === void 0 ? '' : _l,
    _m = _h.backgroundColor,
    backgroundColor = _m === void 0 ? '' : _m,
    _o = _h.textColor,
    textColor = _o === void 0 ? '' : _o,
    _p = _h.borderRadius,
    borderRadius = _p === void 0 ? 8 : _p,
    _q = _h.fontFamily,
    fontFamily = _q === void 0 ? '' : _q,
    _r = _h.showLabels,
    showLabels = _r === void 0 ? true : _r,
    _s = _h.formLayout,
    formLayout = _s === void 0 ? 'stacked' : _s;
  // Generate CSS variables for dynamic styling
  var cssVariables = __assign(
    __assign(
      __assign(
        __assign(
          __assign(
            __assign({}, buttonColor && { '--button-bg': buttonColor }),
    ...
    borderRadius && { '--border-radius': ''.concat(borderRadius, 'px') },
  );
  return _jsxs('div', {
    className: cn(
    ...
    children: [
      _jsxs('form', {
        ...
        children: [
          _jsxs('div', {
            className: styles['waitlist-widget__field'],
            children: [
              showLabels &&
                _jsx(Label, {
                  htmlFor: 'name',
