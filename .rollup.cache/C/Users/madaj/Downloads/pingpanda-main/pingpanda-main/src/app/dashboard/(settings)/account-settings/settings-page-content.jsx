...
var AccountSettingsContent = function () {
  ...
  var _d = useState({
      name: '',
      email:
        ((_a = user === null || user === void 0 ? void 0 : user.emailAddresses[0]) === null ||
        _a === void 0
          ? void 0
          : _a.emailAddress) || '',
      company: '',
  ...
  var _e = useState({
    ...
    waitlistPrefs = _e[0],
    setWaitlistPrefs = _e[1];
  var _f = useState(false),
    isSavingPrefs = _f[0],
    setIsSavingPrefs = _f[1];
  var _g = useState({
      email: true,
  ...
  var _h = useState(false),
    isSavingNotifications = _h[0],
    setIsSavingNotifications = _h[1];
  var _j = useState({
  ...
  var _m = useState(0),
    lastUpdate = _m[0],
    setLastUpdate = _m[1]; // Used to force re-renders
  var _o = useState({
      waitlistUsage: 0,
      signupUsage: 0,
      storageUsage: 0,
            ...
            switch (_b.label) {
              ...
              case 3:
                ...
                setFormData(function (prev) {
                  ...
                  return __assign(__assign({}, prev), {
                    name: profileData_1.name || '',
                    email:
                      profileData_1.email ||
                      ((_a = user.emailAddresses[0]) === null || _a === void 0
                        ? void 0
                        : _a.emailAddress) ||
                      '',
                    company: profileData_1.company || '',
                    website: profileData_1.website || '',
                    bio: profileData_1.bio || '',
                    timezone: profileData_1.timezone || 'UTC',
                  });
                });
                _b.label = 4;
              case 4:
              ...
              case 5:
                ...
                setWaitlistPrefs(function (prev) {
                  return __assign(__assign(__assign({}, prev), prefsData_1), {
                    maxSubscribers: prefsData_1.maxSubscribers || 1000,
                  });
                });
                _b.label = 6;
              case 6:
  ...
  var handleChange = function (e) {
    ...
    setFormData(function (prev) {
      ...
      return __assign(
        __assign({}, prev),
        ((_a = {}), (_a[name] = value !== null && value !== void 0 ? value : ''), _a),
      );
    });
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            setFormData(function (prev) {
              return __assign(__assign({}, prev), data_1);
            });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            setWaitlistPrefs(function (prev) {
              return __assign(__assign({}, prev), data_2);
            });
            // Show success message
            toast({
              title: 'Success',
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            setNotifications(function (prev) {
              return __assign(__assign({}, prev), data_3);
            });
            return [3 /*break*/, 5];
          case 3:
            error_4 = _a.sent();
  ...
  var saveNotificationPreferences = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var response, errorData, updatedPrefs, error_5;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (isSavingNotifications) return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              data = _a.sent();
              validPlan =
                data.plan && Object.keys(planConfigs).includes(data.plan) ? data.plan : 'FREE';
              setMetrics({
   ...
   */
  var handleNotificationToggle = function (key) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            newNotifications = __assign(
              __assign({}, notifications),
              ((_a = {}), (_a[key] = newValue), _a),
            );
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                <Badge
                  className={'ml-2 bg-gradient-to-r from-'
                    .concat(currentPlan.color, '-600 to-')
                    .concat(currentPlan.color === 'gray' ? 'gray' : 'purple', '-600 text-white')}
                >
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div
                className={'flex items-center gap-3 p-4 bg-gradient-to-br from-'
                  .concat(currentPlan.color, '-50 to-white rounded-lg border border-')
                  .concat(currentPlan.color, '-100')}
              >
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    ...
                    <span
                      className={'text-xs bg-'
                        .concat(currentPlan.color, '-100 text-')
                        .concat(currentPlan.color, '-800 px-2 py-0.5 rounded-full')}
                    >
                  ...
                  <div className="mt-1">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className={'bg-'.concat(currentPlan.color, '-600 h-2 rounded-full')}
                        style={{
                          width: ''.concat(
                            Math.min(
                              100,
                              (Number(metrics.activeWaitlists || 0) / currentPlan.maxWaitlists) *
                                100,
                            ),
                            '%',
                          ),
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">
                    {isLoading
                      ? '...'
                      : ''.concat(Number(metrics.conversionRate || 0).toFixed(1), '%')}
                  </p>
            ...
            <div
              className={'bg-'
                .concat(currentPlan.color, '-50 rounded-lg p-4 border border-')
                .concat(currentPlan.color, '-100')}
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                {currentPlan.features.map(function (feature, index) {
                  return (
                    <div
                      key={index}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={function (checked) {
                  return handlePrefsChange('autoApproveSubscribers', checked);
                }}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={function (checked) {
                  return handlePrefsChange('emailNotifications', checked);
                }}
              />
            </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={function () {
                return handleNotificationToggle('email');
              }}
            />
          </div>
          ...
          <div className="ml-4 space-y-4 border-l-2 border-gray-100 pl-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={function () {
                  return handleNotificationToggle('signupAlerts');
                }}
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={function () {
                  return handleNotificationToggle('waitlistMilestones');
                }}
                disabled={!notifications.email}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={function () {
                  return handleNotificationToggle('dailyReports');
                }}
                disabled={!notifications.email}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={function () {
                  return handleNotificationToggle('weeklyDigest');
                }}
                disabled={!notifications.email}
              />
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={function () {
                return handleNotificationToggle('integrationUpdates');
              }}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={function () {
                return handleNotificationToggle('securityAlerts');
              }}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={function () {
                return handleNotificationToggle('marketing');
              }}
            />
          </div>
        </CardContent>
