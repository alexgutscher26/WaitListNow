...
export function ExportButton(_a) {
    ...
    return (_jsx(Button, { variant: "outline", size: "sm", className: "gap-2", onClick: handleExport, disabled: isLoading, children: isLoading ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Exporting..."] })) : (_jsxs(_Fragment, { children: [_jsx(Download, { className: "h-4 w-4" }), "Export"] })) }));
}
//# sourceMappingURL=export-button.js.map