...
type Activity = NewSubscriberActivity | WaitlistCreatedActivity | ReferralActivity | ConversionActivity | MilestoneActivity
  ...
  switch (activity.type) {
      ...
      return (
        <div>
          <p className="text-sm font-medium">
            <span className="font-semibold">{activity.name}</span> joined <span className="text-primary">{activity.waitlist}</span>
          </p>
    ...
    case 'conversion':
      return (
        <div>
          <p className="text-sm font-medium">
            <span className="font-semibold">{activity.name}</span> converted from <span className="text-primary">{activity.waitlist}</span>
          </p>
          <p className="text-xs text-muted-foreground">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Latest actions across your waitlists
                </CardDescription>
              </div>
        ...
        <CardContent>
          {waitlists.length > 0 ? (
            ...
            <div className="text-center py-8">
              <p className="text-muted-foreground mb-4">No waitlists found. Create your first waitlist to get started.</p>
              <Button asChild>
