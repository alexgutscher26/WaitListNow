...
import { Star, Users, Zap, BarChart3, Mail, ChevronRight, ArrowRight, MessageCircle, Award, BarChart2, Rocket, Trophy, } from 'lucide-react';
...
export default function Page() {
    return (<div className="min-h-screen">
          ...
          <div className="relative mx-auto text-center flex flex-col items-center gap-8">
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <ShinyButton href="/sign-up" className="h-14 px-8 text-base font-medium shadow-lg hover:scale-[1.02] bg-gradient-to-r from-brand-600 to-brand-700 hover:from-brand-700 hover:to-brand-800">
                  Get Started Free
                </ShinyButton>
                <Link href="#how-it-works" className="inline-flex items-center justify-center h-14 px-6 text-base font-medium text-gray-700 transition-colors duration-200 bg-white border border-gray-200 rounded-lg hover:bg-gray-50">
                  How it works
            ...
            <div className="aspect-video bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <div className="max-w-sm mx-auto space-y-3">
                  <input type="email" placeholder="Enter your email" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent"/>
      ...
      <section id="how-it-works" className="py-20 sm:py-28 bg-white">
        ...
        ].map(function (step, index) { return (<div key={index} className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-20 bg-white">
        <MaxWidthWrapper>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {caseStudies.map(function (study, index) { return (<div key={index} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
        ...
        <MaxWidthWrapper>
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="space-y-12">
              {timeline.map(function (item, index) { return (<div key={index} className={"relative flex items-center ".concat(index % 2 === 0 ? 'flex-row' : 'flex-row-reverse')}>
                  <div className="flex-1">
                    <div className={"p-6 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow ".concat(index % 2 === 0 ? 'mr-8' : 'ml-8')}>
      ...
      <section id="faq" className="py-20 sm:py-28 bg-white">
        ...
        ].map(function (category, catIndex) { return (<div key={catIndex} className="space-y-4">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{category.category}</h3>
                <div className="space-y-4">
                  {category.items.map(function (faq, index) { return (<div key={index} className="bg-white p-6 rounded-xl border border-gray-200">
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                <Image src="/user-2.png" className="rounded-full object-cover" alt="Sarah Chen" width={48} height={48}/>
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                <Image src="/user-1.png" className="rounded-full object-cover" alt="Marcus Rodriguez" width={48} height={48}/>
                <div className="flex flex-col items-center sm:items-start">
                  <p className="font-semibold flex items-center">
                    Marcus Rodriguez
                    <Icons.verificationBadge className="size-4 inline-block ml-1.5"/>
          ...
          <div className="text-center max-w-2xl">
            ...
            <div className="flex justify-center">
              <ShinyButton href="/sign-up" className="h-14 w-full max-w-xs text-base shadow-lg bg-gradient-to-r from-brand-600 to-brand-700 hover:from-brand-700 hover:to-brand-800">
