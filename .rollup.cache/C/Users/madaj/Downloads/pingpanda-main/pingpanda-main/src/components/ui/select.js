...
var SelectScrollUpButton = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx(SelectPrimitive.ScrollUpButton, __assign({ ref: ref, className: cn('flex cursor-default items-center justify-center py-1', className) }, props, { children: _jsx(ChevronUpIcon, { className: "h-4 w-4" }) })));
});
SelectScrollUpButton.displayName = SelectPrimitive.ScrollUpButton.displayName;
var SelectScrollDownButton = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (_jsx(SelectPrimitive.ScrollDownButton, __assign({ ref: ref, className: cn('flex cursor-default items-center justify-center py-1', className) }, props, { children: _jsx(ChevronDownIcon, { className: "h-4 w-4" }) })));
});
